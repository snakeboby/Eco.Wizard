...
export function activate(context: vscode.ExtensionContext) {
    ...
    function createFile(strName: string): string {
        try {
...
class EcoCPeerfPanel {
    public static currentPanel: EcoCPeerfPanel | undefined;

    public static createOrShow(extensionUri: vscode.Uri, panelHtmlPath: vscode.Uri) {
    ...
    private readonly _panelHtmlPath: vscode.Uri;
    private _disposables: vscode.Disposable[] = [];

    private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, panelHtmlPath: vscode.Uri) {
        this._panel = panel;
    ...
    private _getHtmlContent(htmlPath: vscode.Uri): string {
